    ...
    fetch(
      ...
      .then((responseText) => {
        ...
        const variantPickerDestination =
          document.querySelector("variant-radios") || document.querySelector("variant-selects");
        const variantPickerSource =
          html.querySelector("variant-radios") || html.querySelector("variant-selects");
  ...
  initOptions() {
    ...
    if (sizeFieldSet && this.getAvailableVariantsCount() != 1) {
      ...
      if (fieldInputs.length > 1) {
        const activeFieldInput = Array.from(fieldInputs).find((input) =>
...
class FeaturedSwatch extends HTMLElement {
  constructor() {
    super();
    this.urlContainer =
      this.closest(".featured-product-alt").querySelectorAll(".featured-prod-link");
    this.imgContainer = this.closest(".featured-product-alt").querySelector(
      ".featured-product-alt-imagelink img"
    );
    this.imgDiv = this.closest(".featured-product-alt").querySelector(
      ".featured-product-alt-product-image"
    );
...
if (document.querySelector("#shopify-section-announcement-bar .slideshow_controls_container")) {
  if (
    document
      .querySelector("#shopify-section-announcement-bar .slideshow_controls_container")
      .classList.contains("inline")
  ) {
    var currentColorScheme = document
      .querySelector("#Slider-announcement-bar .slideshow__slide")
      .getAttribute("data-color-scheme");
    var slideshowControlsContainer = document.querySelector(
      "#shopify-section-announcement-bar .slideshow_controls_container"
    );
...
if (document.querySelector("#shopify-section-announcement-bar slideshow-component")) {
  announcementSliderObserver.observe(
    document.querySelector("#Slider-announcement-bar .slideshow__slide"),
    {
...
var updateSliderControlColor = debounce(function () {
  ...
  var newColorScheme = document
    .querySelector('#Slider-announcement-bar .slideshow__slide[aria-hidden="false"]')
    .getAttribute("data-color-scheme");
...
/* page load */
if (document.querySelector("#shopify-section-announcement-bar slideshow-component")) {
  var currentAnnounementSlideHeight = document.querySelector(
    "#Slider-announcement-bar .slideshow__slide .announcement-bar"
  ).offsetHeight;
  setTimeout(function () {
    document.getElementById("Slider-announcement-bar").style.height =
      currentAnnounementSlideHeight + "px";
  }, 1);
}
...
var updateAnnouncementBarHeight = debounce(function () {
  ...
  if (
    document.querySelector(
      '#Slider-announcement-bar .slideshow__slide[aria-hidden="false"] .announcement-bar'
    ) !== null
  ) {
    currentAnnounementSlideHeight = document.querySelector(
      '#Slider-announcement-bar .slideshow__slide[aria-hidden="false"] .announcement-bar'
    ).offsetHeight;
  } else {
    currentAnnounementSlideHeight = document.querySelector(
    ...
    function instantiateTimer() {
      document.querySelectorAll("countdown-to-date").forEach((announcement) => {
        ...
        var countDownDate = new Date(
          announcement.getAttribute("data-datetime").replace(/-/g, "/")
        ).getTime();
...
class groupedProductSwatchToggle extends HTMLElement {
  constructor() {
    ...
    this.addEventListener("click", (event) => {
      ...
      var targetCard = containerParent.querySelector(
        ".grouped-collection-container [data-card-product-container-url='" + cardToToggleURL + "']"
      );
...
function swatchSwiperSetup() {
  ...
  for (i = 0; i < swatchSwiper.length; i++) {
    if (swatchSwiper[i].querySelectorAll(".swiper-slide").length < 5) {
      ...
      swatchSwiper[i]
        .closest(".grouped-collection-container")
        .classList.add("less-than-five-swatches");
      ...
      swatchSwiper[i]
        .closest(".grouped-collection-container")
        .classList.add("swiper-container-parent-" + i);
      var slider = new Swiper(".swiper-container-" + i, {
        slidesPerView: 4,
        slidesPerGroup: 4,
        loop: false,
  ...
  constructor() {
    ...
    this.addEventListener("click", (event) => {
      ...
      buttonElement.parentElement
        .querySelector(".card-wrapper.active button.quick-add__submit")
        .click();
    });
  }
}
