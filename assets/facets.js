class FacetFiltersForm extends HTMLElement {
  ...
  static searchParametersColor(event, searchParams) {
    ...
    if (
      searchParams.includes("filter.v.option.size") &&
      !searchParams.includes("filter.v.availability")
    ) {
      // sets default availability filter to "In Stock" elements
      const instockInput = event.target
        .closest("form")
        .querySelector("input[name='filter.v.availability'][value='1']");
